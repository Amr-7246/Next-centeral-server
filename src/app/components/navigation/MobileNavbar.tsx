...
const MobileNavbar = () => {
  ...
  return (
    <div className=''>
      {/* mobile nav bar */}
        <nav ref={navRef}  className="bg-bg-dark shadow-lg fixed shadow-black/30 top-0 z-10 border-b border-black/50 flex-center md:!hidden !justify-between items-center h-fit w-[100%] py-1 px-5 ">

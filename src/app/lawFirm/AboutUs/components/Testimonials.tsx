...
const Testimonials = () => {
  ...
  return (
    <div className="w-full py-12 px-6 space-y-16 bg-lf-db">
      {/* Core Values */}
      ...
      <div className="grid md:grid-cols-4 gap-8">
        {coreValues.map((value) => (
          <div
            key={value.id}
            className="relative flex flex-col items-center text-center space-y-4 bg-lf-w/10 rounded-xl p-6 shadow-sm"
          >
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {testimonials.map((t) => (
          <div key={t.id} className= "relative bg-lf-g/50 rounded-lg shadow px-6 pt-[50px] flex flex-col justify-between space-y-4" >

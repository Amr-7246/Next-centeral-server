    ...
    <section className="relative">
      {/*//& Animated background with Hero content */}
        <div className='relative w-full h-[90vh]'>
          <DarkVeil hueShift={15} noiseIntensity={0.2} scanlineIntensity={0.2} speed={0.5} scanlineFrequency={3} warpAmount={3} />
              ...
              {features.map((feature, index) => (
                <div key={index} className=" relative backdrop-blur-md bg-white/10 p-6 rounded-lg border border-white/80 ">
                  <div className="flex flex-col items-center text-center">
                    <span className='absolute top-3 left-3 bg-black/50 rounded-full border-white border text-[15px] p-2'>
                      {feature.icon}
                    </span>

...
const FirmPref = () => {
  return (
    <>
      {/*//& text content */}
        <div className='absolute left-0 top-[30%] border-l-2 border-sky-400/50 h-[50%] w-[40vw] flex flex-col items-between justify-between'>
          <div>
            <p className="text-lf-dw text-[17px] w-full mx-auto border-b-2 border-sky-400/50 p-5 text-center">
          ...
          <div>
            <h2 className="z-2 pb-2 pl-5 w-full text-center text-[23px] text-lf-dy border-b-2 border-sky-400/50 ">
        ...
        <div className='absolute bottom-10 right-10 w-[50%] flex flex-col gap-5' >
          <h2 className="z-2 pb-2 w-full text-center text-[23px] text-lf-dy border-b-2 border-sky-400/50 ">

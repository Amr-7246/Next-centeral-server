...
export function ThemeToggle({ className = '' }: ThemeToggleProps) {
  ...
  return (
    <motion.button
      onClick={toggleTheme}
      className={` relative inline-flex h-10 w-10 items-center justify-center rounded-full text-sm font-medium hover:text-[var(--text)] transition-colors duration-200 cursor-pointer ${className} `}
